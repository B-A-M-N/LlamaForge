...
ADDITIONAL_JSONL = [
    ...
    Path("data/identity/leviathan_identity_5k.jsonl"),
    Path("examples/datasets/uncensored_boost/dolphin_uncensored.jsonl"),
    Path("examples/datasets/uncensored_boost/openhermes.jsonl"),
    Path("examples/datasets/uncensored_boost/wizardlm_uncensored.jsonl"),
    Path("examples/datasets/uncensored_academic/uncensored_academic_core.jsonl"),
    Path("examples/datasets/claude_mega_142k.jsonl"),
    Path("examples/datasets/claude_ultimate_508k.jsonl"),
    Path("examples/datasets/claude_ultimate_with_tools_621k.jsonl"),
    Path("examples/datasets/magicoder_evol_110k.jsonl"),
    Path("examples/datasets/magicoder_oss_75k.jsonl"),
    Path("examples/datasets/expansion_phase5/algorithmic_reasoning/apps_reasoning.jsonl"),
    Path("examples/datasets/expansion_phase5/algorithmic_reasoning/code_contests.jsonl"),
    Path("examples/datasets/expansion_phase5/formal_logic/formal_fallacies.jsonl"),
    Path("examples/datasets/expansion_phase5/formal_logic/logic_grid_puzzle.jsonl"),
    Path("examples/datasets/expansion_phase5/formal_logic/logical_deduction.jsonl"),
    Path("examples/datasets/expansion_phase5/metacognition/debug_traces_synthetic.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/natural_questions.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/qasc.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/boolq.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/arc_easy.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/commonsense_qa.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/squad.jsonl"),
    Path("examples/datasets/expansion_phase5_fast/codesearchnet_python.jsonl"),
    Path("examples/datasets/gap_filling/exercises/python_exercises.jsonl"),
    Path("examples/datasets/gap_filling/database/sql_create_context.jsonl"),
    Path("examples/datasets/gap_filling/web_dev/web_development.jsonl"),
    Path("data/external/deepseek/webgpt_comparisons.jsonl"),
    Path("data/external/chatgpt/open_platypus.jsonl"),
]
